...
// Номера SVC вызовов для работы с таблицей драйверов
#define SVC_DRV_TABLE_SET (0x0f + 0x00)
#define SVC_DRV_TABLE_GET (0x0f + 0x01)

// Вспомогательная функция для выполнения SVC вызова с возвращаемым значением
...
// Установка устройства в таблицу драйверов через SVC вызов
...
// Получение устройства из таблицы драйверов через SVC вызов
